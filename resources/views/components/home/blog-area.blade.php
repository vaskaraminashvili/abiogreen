                ...
                <div class="row gx-35">
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="it-blog-item mb-30">
                            ...
                            <div class="it-blog-content">
                                <h4 class="it-blog-title mb-15"><a class="border-line" href="blog-details.html">10
                                        tips for solar panel repair in an industrial setup</a></h4>
                                <p>Construction System Activation Fast, Seamless Switch with Expert Guidance &
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="it-blog-item mb-30">
                            ...
                            <div class="it-blog-content">
                                <h4 class="it-blog-title mb-15"><a class="border-line"
                                        href="blog-details.html">Essential Tips for Maintaining and Extending Solar
                                        Panel</a></h4>
                                <p>Construction System Activation Fast, Seamless Switch with Expert Guidance &
                                    Performance Optimization</p>
                                <a class="it-blog-link" href="blog-details.html">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="it-blog-item mb-30">
                            ...
                            <div class="it-blog-content">
                                <h4 class="it-blog-title mb-15"><a class="border-line"
                                        href="blog-details.html">How Solar Energy Saves Money and Protects the
                                        Environment</a></h4>
                                <p>Construction System Activation Fast, Seamless Switch with Expert Guidance &
                                    Performance Optimization</p>
                                <a class="it-blog-link" href="blog-details.html">
