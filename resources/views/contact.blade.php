            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5">
                    <div class="it-contact-left">
                        <div class="it-section-title-box mb-60">
                            <span class="it-section-subtitle">Contact us</span>
                            <h4 class="it-section-title it-split-text it-split-in-right fz-45 mb-0">Your Message
                                <br>Matters Contact Us</h4>
                        </div>
                        <div class="it-contact-list-wrap">
                            ...
                            <div class="it-contact-list-box d-flex align-items-center mb-30 wow itfadeUp"
                                ...
                                <div class="it-contact-list">
                                    ...
                                    <a class="border-line" href="mailto:info@abio.com.cy">info@abio.com.cy</a>
                                </div>
                            </div>
                            <div class="it-contact-list-box d-flex align-items-center wow itfadeUp"
                                        ...
                                        <svg width="45" height="45" viewBox="0 0 45 45" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_901_19903)">
                                                <path
                                                    ...
                                                    fill="#2DC457" />
                                                <path
                                                    d="M22.4996 44.9998C20.9208 45.0079 19.3629 44.6376 17.9566 43.9199C16.5503 43.2023 15.3364 42.1581 14.4165 40.8748C7.27086 31.018 3.64648 23.608 3.64648 18.8492C3.64648 13.8491 5.63279 9.05369 9.16844 5.51805C12.7041 1.9824 17.4995 -0.00390625 22.4996 -0.00390625C27.4998 -0.00390625 32.2951 1.9824 35.8308 5.51805C39.3664 9.05369 41.3527 13.8491 41.3527 18.8492C41.3527 23.608 37.7284 31.018 30.5827 40.8748C29.6629 42.1581 28.4489 43.2023 27.0426 43.9199C25.6363 44.6376 24.0785 45.0079 22.4996 44.9998ZM22.4996 4.08922C18.5854 4.09369 14.8328 5.65058 12.065 8.41835C9.29722 11.1861 7.74033 14.9388 7.73586 18.853C7.73586 22.6217 11.2852 29.5911 17.7277 38.4767C18.2747 39.2301 18.9922 39.8432 19.8216 40.266C20.651 40.6888 21.5687 40.9092 22.4996 40.9092C23.4305 40.9092 24.3483 40.6888 25.1776 40.266C26.007 39.8432 26.7246 39.2301 27.2715 38.4767C33.714 29.5911 37.2634 22.6217 37.2634 18.853C37.2589 14.9388 35.702 11.1861 32.9342 8.41835C30.1665 5.65058 26.4138 4.09369 22.4996 4.08922Z"
                                                    fill="#2DC457" />
                                            </g>
                                            <defs>
                                ...
                                <div class="it-contact-list">
                                    ...
                                    <a class="border-line" target="_blank" href="https://maps.app.goo.gl/5846QKistNDa9q5p6">Tetrick Larnakos Avenue 62, 2101, Aglantzia Nicosia</a>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-7 col-lg-7 wow itfadeRight" data-wow-duration=".9s" data-wow-delay=".3s">
                    <div class="it-contact-2-form-box">
                        <h4 class="it-contact-form-title mb-30">We’d love to hear from you</h4>
                        <form action="#">
                            <div class="it-contact-input-wrap">
                                <div class="row gx-20">
                                    ...
                                    <div class="it-contact-btn">
                                        <button type="submit" class="it-btn-theme">
                                            <span>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="it-map-wrap">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d892.7040348199736!2d33.3922347!3d35.1574883!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14de1763d246a679%3A0x4d680ceb7de551bf!2sABIO%20Power%20LTD!5e1!3m2!1sen!2sge!4v1759236147500!5m2!1sen!2sge"
