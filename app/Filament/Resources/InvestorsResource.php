...
use App\Filament\Resources\InvestorsResource\Pages;
...
class InvestorsResource extends Resource
{
    protected static ?string $model = Investors::class;
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('title')
                    ->label('Title')
                    ->getStateUsing(
                        fn (Investors $record): string => $record->getTranslation('title', app()->getLocale()) ??
                ...
                Tables\Columns\TextColumn::make('short_description')
                    ...
                    ->getStateUsing(
                        fn (Investors $record): string => (string) ($record->getTranslation('short_description', app()->getLocale()) ??
