...
class SustainabilityResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Sustainability';

    protected static ?string $modelLabel = 'Sustainability';

    protected static ?string $pluralModelLabel = 'Sustainability';
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('title')
                    ->label('Title')
                    ->getStateUsing(
                        fn (Sustainability $record): string => $record->getTranslation('title', app()->getLocale()) ??
                ...
                Tables\Columns\TextColumn::make('short_description')
                    ...
                    ->getStateUsing(
                        fn (Sustainability $record): string => (string) ($record->getTranslation('short_description', app()->getLocale()) ??
